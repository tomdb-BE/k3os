# rke2OS Packer VMware image

This is a working template for building rke2OS Server and Agent templates using packer in VMware.
...
Download the [latest version](https://github.com/rancher/rke2os/releases/latest) version of rke2os and copy it to your vCenter datastore.

Assuming that packer and packer-builder-vware-iso are installed you will run the following commands:

packer.io build -var-file rke2os-server-variables.json rke2os-server.json
...
```
{
    ...
    "vcenter_iso_path": "[datastore0] ISOs/rke2os-amd64.iso",
    "hostname": "rke2os-agent-template",
...
## Demo deploying the rke2os agent vm from a template
